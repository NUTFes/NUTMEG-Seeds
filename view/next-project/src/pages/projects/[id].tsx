...
export async function getStaticProps({ params }: any) {
  ...
  const skills: Skill[] = [
    {
      id: 1, name: "Vue.js", role: "Front End",
    },
    {
      id: 2, name: "Ruby on Rails", role: "Back End",
    },
  ];

  const members: Member[] = [
    {
      id: 1, name: "大場雅士", role: "Front End",
    },
    {
      id: 2, name: "久々江耀平", role: "Front End",
    },
    {
      id: 3, name: "水上涼介", role: "Back End",
    },
    {
      id: 4, name: "五十嵐和亜", role: "Back End",
    },
  ];
